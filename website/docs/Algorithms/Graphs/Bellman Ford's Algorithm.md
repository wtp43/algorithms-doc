...
[negative weight cycles](</docs/TODO/negative weight cycles.md>)- If the resultant is not optimal, then the graph contains a negative weight cycle
...
[Graph Theory](</docs/Algorithms/Graphs/Graph Theory.md>)[Floyd-Warshall's Algorith](</docs/Algorithms/Graphs/Floyd-Warshall's Algorithm.md>)